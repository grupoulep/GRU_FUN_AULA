  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold text-slate-900 tracking-tight">Gestión de Banners Publicitarios</h2>
          <p className="text-sm text-slate-500 mt-1">
            Agrega y edita los banners que se mostrarán en el carrusel del portal del estudiante.
          </p>
        </div>
        {!isAdding && (
          <button
      ...
      {isAdding && (
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs animate-in fade-in slide-in-from-top-4">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-base font-bold text-slate-900">Agregar Nuevo Banner</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {banners.length === 0 && !isAdding && (
          <div className="col-span-full py-16 bg-slate-50 border border-slate-200 border-dashed rounded-2xl flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-base font-bold text-slate-900">No hay banners publicados</h3>
            <p className="text-sm text-slate-500 mt-1 max-w-sm">
              Comienza agregando tu primer banner promocional haciendo clic en "Nuevo Banner".
            </p>
          </div>
        )}
